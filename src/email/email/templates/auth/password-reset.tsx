...
}: AyahayPasswordResetProps) {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Preview>Reset your password - Ayahay</Preview>
        <Container style={container}>
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              ...
              <Text style={mainText}>
                We received a request to reset your password for your Ayahay account. 
                If you didn't make this request, you can safely ignore this email.
              </Text>
              <Text style={mainText}>
                To reset your password securely, click the button below:
              </Text>
              ...
              <Text style={expirationText}>
                This link will expire in {expirationTime} for your security.
              </Text>
              <Text style={troubleText}>
            ...
            <Section style={lowerSection}>
              <Text style={cautionText}>
                🔐 Security Note: Ayahay will never ask you to share your password via email. 
          ...
          <Text style={footerText}>
            This password reset was sent by Ayahay. © 2024, Ayahay. All
            rights reserved.
            <br />
            <Link
...
AyahayPasswordReset.PreviewProps = {
  name: 'John Doe',
  resetUrl: 'https://ayahay.com/reset-password?token=abc123xyz',
  expirationTime: '24 hours',
} satisfies AyahayPasswordResetProps;
